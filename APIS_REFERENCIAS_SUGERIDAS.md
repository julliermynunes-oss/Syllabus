...
### 2. **Semantic Scholar API** ⭐ RECOMENDADA
...
### 6. **DOAJ API** (Directory of Open Access Journals)
...
### Alta Prioridade:
1. **arXiv** - Muito popular, API simples, sem API key
2. **Semantic Scholar** - Popular, dados ricos, sem API key (com rate limit)

### Média Prioridade:
3. **PubMed** - Essencial para área biomédica, mas formato XML mais complexo
4. **DOAJ** - Boa para revistas de acesso aberto

### Baixa Prioridade:
5. **ORCID** - Mais útil para busca por pesquisador
6. **OpenCitations** - Mais focado em análise de citações
...
1. **arXiv** - Fácil de implementar, muito usado, sem API key
2. **Semantic Scholar** - Popular, dados ricos, mas com rate limit

Ambas podem ser implementadas sem necessidade de API keys adicionais e complementam bem as APIs já existentes.
