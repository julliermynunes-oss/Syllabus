...
const CompetenciesTablePDF = ({ data }) => {
  ...
  if (!data || data === '' || data === '[]') {
    return <div style={{ fontSize: '18px', color: '#666', fontStyle: 'italic' }}>{t('noCompetencies')}</div>;
  }
  ...
  try {
    ...
    return (
      <table style={{ width: '100%', borderCollapse: 'collapse', marginTop: '15px', fontSize: '18px' }}>
        <thead>
          <tr style={{ backgroundColor: '#235795', color: '#fff' }}>
            <th style={{ padding: '14px 12px', textAlign: 'left', border: '1px solid #235795', fontSize: '18px' }}>{t('competence')}</th>
            <th style={{ padding: '14px 12px', textAlign: 'left', border: '1px solid #235795', fontSize: '18px' }}>{t('descriptionField')}</th>
            <th style={{ padding: '14px 12px', textAlign: 'center', border: '1px solid #235795', fontSize: '18px', width: '140px' }}>{t('contributionDegree')}</th>
          </tr>
        </thead>
        <tbody>
          {rows.map((row, index) => (
    ...
    return <div style={{ fontSize: '18px', color: '#666', fontStyle: 'italic' }}>{t('errorLoadingCompetencies')}</div>;
  }
};
    ...
    sections.push({
      ...
      component: (
        <div key="info_gerais" style={{ marginBottom: '30px', marginTop: '0', paddingBottom: '0', minHeight: '0', height: 'auto', overflow: 'visible' }}>
          ...
          <h3 style={{ fontSize: '26px', color: '#235795', borderBottom: '2px solid #a4a4a4', paddingBottom: '12px', marginBottom: '18px', marginTop: '0', paddingTop: '0' }}>
            {t('generalInformation')}
          </h3>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '14px', fontSize: '18px', width: '100%' }}>
            {formData.disciplina && (
              <div>
          ...
          sections.push({
            ...
            component: (
              <div key="professores" style={{ marginBottom: '30px', marginTop: '0', paddingTop: '0', pageBreakInside: 'avoid' }}>
                <h3 style={{ fontSize: '26px', color: '#235795', borderBottom: '2px solid #a4a4a4', paddingBottom: '12px', marginBottom: '10px', marginTop: '0', paddingTop: '0' }}>
                  {t('professorsTitle')}
                </h3>
                    ...
                    return (
                      <div key={professorNome} style={{ 
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '15px', marginBottom: '12px', pageBreakInside: 'avoid' }}>
                          ...
                          <h4 style={{ margin: 0, color: '#235795', fontSize: '20px', fontWeight: 'bold', pageBreakAfter: 'avoid' }}>{professorNome}</h4>
                        </div>
                        {profData.descricao && (
                          <div 
                            style={{ 
      ...
      sections.push({
        ...
        component: (
          <div key="sobre" style={{ marginBottom: '30px', pageBreakInside: 'avoid' }}>
            <h3 style={{ fontSize: '26px', color: '#235795', borderBottom: '2px solid #a4a4a4', paddingBottom: '12px', marginBottom: '18px' }}>
          ...
          <div key="competencias" style={{ marginBottom: '30px', pageBreakInside: 'avoid' }}>
            ...
            {formData.curso && (
              <div style={{ marginBottom: '15px', padding: '14px 20px', background: '#f8f9fa', borderLeft: '4px solid #235795', borderRadius: '4px' }}>
                <p style={{ margin: 0, fontSize: '18px', color: '#4a5568', lineHeight: '1.7' }}>
          ...
          if (parsed && parsed.rows && parsed.rows.length > 0) {
            return (
              <div style={{ marginBottom: '30px', pageBreakInside: 'avoid' }}>
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '20px', fontSize: '18px' }}>
                  <thead>
                ...
                {parsed.observacoes && parsed.observacoes.trim() !== '' && (
                  <div style={{ marginTop: '15px', padding: '14px', background: '#f9f9f9', borderRadius: '4px', fontSize: '18px', lineHeight: '1.7' }}>
