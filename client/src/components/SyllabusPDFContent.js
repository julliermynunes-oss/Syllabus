          ...
          sections.push({
            ...
            component: (
              <div key="professores" className="professores-section" style={{ marginBottom: '30px', marginTop: '0', paddingTop: '0', pageBreakInside: 'avoid' }}>
                <h3 style={{ fontSize: '15px', color: 'white', backgroundColor: '#808080', padding: '5px 10px', marginBottom: '10px', marginTop: '0', paddingTop: '5px', paddingBottom: '5px', border: 'none' }}>
                  {t('professorsTitle')}
                </h3>
      ...
      sections.push({
        ...
        component: (
          <div key="sobre" style={{ marginBottom: '30px', ...(hasTableOrImg ? { pageBreakInside: 'avoid' } : {}) }}>
            <h3 style={{ fontSize: '15px', color: 'white', backgroundColor: '#808080', padding: '5px 10px', marginBottom: '12px', border: 'none' }}>
