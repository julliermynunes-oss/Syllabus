          ...
          sections.push({
            ...
            component: (
              <div key="professores" className="professores-section" style={{ marginBottom: '30px', marginTop: '0', paddingTop: '0', pageBreakInside: 'avoid' }}>
                <h3 style={{ fontSize: '13px', color: '#000', fontWeight: 'bold', backgroundColor: '#d3d3d3', padding: '0px 8px', marginBottom: '8px', marginTop: '0', paddingTop: '0px', paddingBottom: '0px', border: 'none', lineHeight: '1.4' }}>
                  {t('professorsTitle')}
                </h3>
      ...
      sections.push({
        ...
        component: (
          <div key="sobre" style={{ marginBottom: '30px', ...(hasTableOrImg ? { pageBreakInside: 'avoid' } : {}) }}>
            <h3 style={{ fontSize: '13px', color: '#000', fontWeight: 'bold', backgroundColor: '#d3d3d3', padding: '0px 8px', marginBottom: '8px', border: 'none', lineHeight: '1.4' }}>
