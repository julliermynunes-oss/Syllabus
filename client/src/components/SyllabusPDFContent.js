  ...
  const getOrderedSections = () => {
      ...
      try {
        ...
        if (professoresComDados.length > 0) {
          sections.push({
            id: 'professores',
            component: (
              <div key="professores" className="professores-section" style={{ marginBottom: '12px', marginTop: '0', paddingTop: '0', pageBreakInside: 'avoid' }}>
    ...
    if (formData.sobre_disciplina) {
      ...
      sections.push({
        id: 'sobre',
        component: (
          <div key="sobre" style={{ marginBottom: '12px', ...(hasTableOrImg ? { pageBreakInside: 'avoid' } : {}) }}>
            <h3 style={{ fontSize: '15px', color: '#000', fontWeight: 'bold', backgroundColor: 'transparent', padding: '0', marginBottom: '10px', marginTop: '15px', border: 'none', lineHeight: '1.4', textAlign: 'left' }}>
    ...
    if (formData.compromisso_etico) {
      sections.push({
        ...
        component: (
          <div key="compromisso_etico" className="compromisso-etico-section" style={{ marginBottom: '12px' }}>
            <h3 style={{ fontSize: '15px', color: '#000', fontWeight: 'bold', backgroundColor: 'transparent', padding: '0', marginBottom: '10px', marginTop: '15px', border: 'none', lineHeight: '1.4', textAlign: 'left' }}>
    ...
    if (formData.competencias) {
      ...
      sections.push({
        id: 'competencias',
        component: (
          <div key="competencias" style={{ marginBottom: '12px', pageBreakInside: 'avoid' }}>
            <h3 style={{ fontSize: '15px', color: '#000', fontWeight: 'bold', backgroundColor: 'transparent', padding: '0', marginBottom: '10px', marginTop: '15px', border: 'none', lineHeight: '1.4', textAlign: 'left' }}>
              {t('competenciesTitle')}
            </h3>
            {formData.curso && (
    ...
    if (formData.ods && !isRestrictedCourse(formData.curso)) {
      ...
      sections.push({
        id: 'ods',
        component: (
          <div key="ods" style={{ marginBottom: '12px', ...(hasTableOrImg ? { pageBreakInside: 'avoid' } : {}) }}>
            <h3 style={{ fontSize: '15px', color: '#000', fontWeight: 'bold', backgroundColor: 'transparent', padding: '0', marginBottom: '10px', marginTop: '15px', border: 'none', lineHeight: '1.4', textAlign: 'left' }}>
              {t('odsTitle')}
            </h3>
            <div 
    ...
    if (formData.conteudo) {
      ...
      sections.push({
        id: 'conteudo',
        component: (
          <div key="conteudo" style={{ marginBottom: '12px', ...(hasTableOrImg ? { pageBreakInside: 'avoid' } : {}) }}>
            <h3 style={{ fontSize: '15px', color: '#000', fontWeight: 'bold', backgroundColor: 'transparent', padding: '0', marginBottom: '10px', marginTop: '15px', border: 'none', lineHeight: '1.4', textAlign: 'left' }}>
              {t('contentTitle')}
            </h3>
            <div 
    ...
    if (formData.metodologia) {
      ...
      sections.push({
        id: 'metodologia',
        component: (
          <div key="metodologia" style={{ marginBottom: '12px', ...(hasTableOrImg ? { pageBreakInside: 'avoid' } : {}) }}>
            <h3 style={{ fontSize: '15px', color: '#000', fontWeight: 'bold', backgroundColor: 'transparent', padding: '0', marginBottom: '10px', marginTop: '15px', border: 'none', lineHeight: '1.4', textAlign: 'left' }}>
              {t('methodologyTitle')}
            </h3>
            <div 
    ...
    if (formData.criterio_avaliacao) {
      const avaliacaoComponent = (() => {
        try {
          ...
          return (
            <div style={{ marginBottom: '12px', ...(hasTableOrImg ? { pageBreakInside: 'avoid' } : {}) }}>
              <h3 style={{ fontSize: '15px', color: '#000', fontWeight: 'bold', backgroundColor: 'transparent', padding: '0', marginBottom: '10px', marginTop: '15px', border: 'none', lineHeight: '1.4', textAlign: 'left' }}>
                {t('evaluationCriteriaTitle')}
              </h3>
              <div 
    ...
    if (formData.o_que_e_esperado && !isRestrictedCourse(formData.curso)) {
      ...
      sections.push({
        id: 'o_que_e_esperado',
        component: (
          <div key="o_que_e_esperado" style={{ marginBottom: '12px', ...(hasTableOrImg ? { pageBreakInside: 'avoid' } : {}) }}>
            <h3 style={{ fontSize: '15px', color: '#000', fontWeight: 'bold', backgroundColor: 'transparent', padding: '0', marginBottom: '10px', marginTop: '15px', border: 'none', lineHeight: '1.4', textAlign: 'left' }}>
    ...
    if (formData.custom_tab_name && formData.custom_tab_content) {
      ...
      const customSection = {
        id: 'custom',
        component: (
          <div key="custom" style={{ marginBottom: '12px', ...(hasTableOrImg ? { pageBreakInside: 'avoid' } : {}) }}>
            <h3 style={{ fontSize: '15px', color: '#000', fontWeight: 'bold', backgroundColor: 'transparent', padding: '0', marginBottom: '10px', marginTop: '15px', border: 'none', lineHeight: '1.4', textAlign: 'left' }}>
    ...
    if (formData.referencias) {
      ...
      sections.push({
        id: 'referencias',
        component: (
          <div key="referencias" style={{ marginBottom: '12px', ...(hasTableOrImg ? { pageBreakInside: 'avoid' } : {}) }}>
            <h3 style={{ fontSize: '15px', color: '#000', fontWeight: 'bold', backgroundColor: 'transparent', padding: '0', marginBottom: '10px', marginTop: '15px', border: 'none', lineHeight: '1.4', textAlign: 'left' }}>
              {t('referencesTitle')}
            </h3>
            {renderReferences()}
    ...
    if (formData.contatos) {
      ...
      sections.push({
        id: 'contatos',
        component: (
          <div key="contatos" style={{ marginBottom: '12px', ...(hasTableOrImg ? { pageBreakInside: 'avoid' } : {}) }}>
            <h3 style={{ fontSize: '15px', color: '#000', fontWeight: 'bold', backgroundColor: 'transparent', padding: '0', marginBottom: '10px', marginTop: '15px', border: 'none', lineHeight: '1.4', textAlign: 'left' }}>
              {t('contactsTitle')}
            </h3>
            <div 
